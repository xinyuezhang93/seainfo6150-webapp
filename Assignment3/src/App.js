    ...
    return (
      <div className="App">
        ...
        <Article 
          ...
          >
          <hr color = "grey"></hr>
          <blockquote className = "articleText">
            ...
            <p><em>"Although it is not one of the most difficult things we have ever moved,"</em> says Douglas Phelps, who oversaw the relocation of the torch, <i>"it is certainly the most important."</i>
            </p>
            ...
            <p><em>"The original torch is a beautiful object of art and exemplifies the American ideals of freedom and democracy,"</em> says John Piltzecker, superintendent of the Statue of Liberty National Monument. That symbolic spirit was bolstered by the decision to inscribe <a href="https://en.wikipedia.org/wiki/Emma_Lazarus">Emma Lazarus</a>' poem <a href = "https://en.wikipedia.org/wiki/The_New_Colossus">"The New Colossus"</a> on the statue's pedestal, which gave Lady Liberty one of her nicknames, "Mother of Exiles."
            </p>
            <p>The most famous lines in the poem are: <em>"Give me your tired, your poor / Your huddled masses yearning to breathe free."</em>
            </p>
